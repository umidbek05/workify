...
const ProfilePage = () => {
  ...
  if (loading) {
    return (
      <div
        className={`min-h-screen p-8 max-w-6xl mx-auto animate-pulse-custom ${
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div
              className={`h-[250px] rounded-[24px] ${
                isDark ? "bg-[#1E1E1E]" : "bg-white"
              }`}
            ></div>
            <div
  ...
  return (
    <div
      className={`min-h-screen p-4 md:p-8 font-sans transition-colors duration-500 ${
        isDark ? "bg-[#121212] text-white" : "bg-[#F8F9FB] text-[#333]"
      }`}
    >
      <style>{spinnerStyle}</style>
      <div className="max-w-6xl mx-auto">
        <div
          className={`rounded-xl p-4 mb-6 shadow-sm flex justify-between items-center border ${
            isDark ? "bg-[#1E1E1E] border-gray-800" : "bg-white border-gray-100"
          }`}
        >
          <h1
            className={`text-xl md:text-2xl font-semibold ${
              isDark ? "text-gray-200" : "text-{#505151"
            }`}
          >
            My profile
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1">
            <div
              className={`rounded-[24px] p-6 shadow-sm relative border text-center transition-all ${
                isDark
            ...
            >
              ...
              <div className="relative inline-block mt-4">
                <div
                  className={`w-28 h-28 rounded-full overflow-hidden border-4 shadow-lg mx-auto flex items-center justify-center ${
                    isDark
                ...
                <button
                  ...
                  className={`absolute bottom-1 right-1 p-2 rounded-full shadow-md border transition ${
                    isDark
                      ? "bg-[#252525] border-gray-700 text-gray-400 hover:bg-blue-600 hover:text-white"
                      : "bg-white border-gray-100 text-gray-500 hover:bg-blue-500 hover:text-white"
                  }`}
                >
                  <FiCamera size={14} />
                </button>
              ...
              <div
                className={`mt-8 pt-6 border-t space-y-3 text-left ${
          ...
          <div className="lg:col-span-2 space-y-6">
            <div
              className={`rounded-[24px] p-8 shadow-sm relative border transition-all ${
                isDark
                  ? "bg-[#1E1E1E] border-gray-800"
                  : "bg-white border-gray-50"
              }`}
                    ...
                    user.skils.map((s, i) => (
                      <span
                        ...
                        className={`px-4 py-2 rounded-lg text-sm border transition-colors ${
                          isDark
                            ? "bg-[#252525] border-gray-700 text-gray-300"
                            : "bg-[#F8F9FB] border-gray-100 text-gray-600"
                        }`}
                      >
            ...
            <div
              className={`rounded-[24px] p-8 shadow-sm relative border min-h-[300px] transition-all ${
                isDark
                  ? "bg-[#1E1E1E] border-gray-800"
                  : "bg-white border-gray-50"
              }`}
      ...
      {activeModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div
            className={`rounded-[24px] w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] ${
              isDark ? "bg-[#1E1E1E] text-white" : "bg-white text-[#333]"
            }`}
          >
            <div className="p-8 overflow-y-auto">
              <div className="flex justify-between items-center mb-8">
                ...
                <button
                  ...
                  className={`p-2 rounded-full transition ${
                    isDark
                      ? "bg-[#252525] text-gray-400 hover:text-red-400"
              ...
              <form onSubmit={handleUpdate} className="space-y-6">
                ...
                {activeModal === "about" && (
                  <textarea
                    className={`w-full h-64 border rounded-xl p-5 focus:outline-none focus:ring-2 ring-blue-500/10 transition ${
                      isDark
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold text-lg transition flex items-center justify-center gap-3 shadow-lg ${
                    saveLoading
                      ...
                      : "bg-[#4AD395] hover:bg-[#3ebe84] shadow-emerald-500/20"
                  } text-white`}
                >
                  {saveLoading ? (
                    <>
...
const InfoRow = ({ label, value, isDark }) => (
  <div
    className={`flex justify-between items-center text-[13px] py-2 border-b last:border-0 ${
...
const InputGroup = ({
  ...
  <div className="w-full text-left">
    ...
    <input
      ...
      className={`w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 ring-emerald-500/10 transition ${
        isDark
          ? "bg-[#252525] border-gray-700 text-white focus:border-emerald-500"
          : "bg-gray-50 border-gray-200 focus:border-emerald-500"
      }`}
