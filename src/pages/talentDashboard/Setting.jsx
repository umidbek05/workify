...
const Setting = () => {
  ...
  // Notification sozlamalari uchun alohida state
  ...
  return (
    <div
      className={`min-h-full p-4 sm:p-6 md:p-8 pb-[100px] md:pb-8 font-sans transition-colors duration-500 ${
        isDarkMode ? "bg-[#121212] text-white" : "bg-[] text-gray-800"
      }`}
    >
      <div className="max-w-[900px] mx-auto relative">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            <SettingItem
              icon={<TbWorld />}
              title="Website"
              desc="Website orqali bildirishnomalar"
              isOn={notifSettings.website}
            ...
            <SettingItem
              ...
              title="Telegram"
              desc="Telegram bot orqali bildirishnomalar"
              isOn={notifSettings.telegram}
            ...
            <SettingItem
              icon={<TbMail />}
              title="Email"
              desc="Email orqali yangiliklar"
              isOn={notifSettings.email}
        ...
        {/* Appearance / Theme qismi */}
        <div className="mb-8">
          <h2 className={`text-[16px] md:text-[18px] font-bold mb-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
            Appearance
          </h2>
          <SettingItem
            icon={<TbWorld />}
            title="Dark Mode"
            desc="Tizim rangini o'zgartirish"
            isOn={isDarkMode}
        ...
        <div className="mb-8">
          ...
          <div
            ...
            className={`${
              isDarkMode ? "bg-[#1E1E1E] border-gray-800" : "bg-white border-gray-50"
        ...
        {showLogoutModal && (
          <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div
              className={`${
                isDarkMode ? "bg-[#1E1E1E] border-gray-700" : "bg-white"
...
const SettingItem = ({ icon, title, desc, isOn, onToggle, CustomToggle, isDark }) => (
  ...
  >
    <div className="flex items-start gap-4">
      <div className={`text-2xl mt-1 ${isDark ? "text-gray-500" : "text-gray-400"}`}>
        {icon}
      </div>
      <div>
        <h3 className={`text-[15px] md:text-[17px] font-bold ${isDark ? "text-gray-200" : "text-gray-800"}`}>
          {title}
        </h3>
        <p className={`text-[11px] md:text-[14px] ${isDark ? "text-gray-400" : "text-gray-500"}`}>
          {desc}
        </p>
      </div>
    </div>
