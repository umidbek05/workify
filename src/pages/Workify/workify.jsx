    ...
    <Header/>
      <section className="hero">
        ...
        <div className="hero-content">
          <h1>
            Find aspiring talents<br />and great employers
          </h1>
          <p>
      ...
      <div className="Card">
        <div className="first">
        <img src={Mask} alt="" />
        <h1>Professional <br /> recruiter</h1>
        <p>Finding the best candidate <br /> is always hard.</p>
        </div>

        <div className="thirst">
        <img src={Person} alt="" />
        <h1>Find the right <br /> job you want fast</h1>
        <p>Launch your career <br /> on Workify.</p>
        </div>

        <div className="second">
        <img src={Message} alt="" />
        <h1>All rofessionals <br /> need some help</h1>
        <p>As a pro recruiter, you need <br /> various skills to hire <br /> a great talent.</p>
        </div>

        <div className="fourth">
        <img src={Search} alt="" />
        <h1>Searching a job may <br /> be long and boring</h1>
        <p>Landing a good gig can be <br /> hard, when you have a <br /> strong competition.</p>
        </div>
      </div>
